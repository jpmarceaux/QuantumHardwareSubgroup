...
def predict_observable_errors_using_pymatching(circuit: stim.Circuit,
    ...
    error_model = circuit.detector_error_model(decompose_errors=True) #,allow_gauge_detectors=True)
...
def logical_error_rate_noisy_graph(circuit,detector_parts,actual_observable_parts):
